...
extension UIImage{
    ...
    static let ic_Success = UIImage(named: "ic_Success") ?? .image_placeholder
    ...
    static let ic_Payout = UIImage(named: "ic_Payout") ?? .image_placeholder
    static let ic_Transactions = UIImage(named: "ic_Transactions") ?? .image_placeholder
    ...
    static let ic_Wallet = UIImage(named: "ic_wallet") ?? .image_placeholder
    static let ic_GST = UIImage(named: "ic_GST") ?? .image_placeholder
